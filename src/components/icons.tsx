...
export function SettingsIcon({ className = "w-3 h-3" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ErrorIcon({ className = "w-5 h-5" }: IconProps) {
  return (
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L12 12m-3.122-3.122l4.243 4.243M12 12l3.878 3.878M12 12v6m0-6l3.878-3.878"
      />
    </svg>
  );
}
...
export function AlertCircleIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function CircleIcon({ className = "w-3 h-3" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function DotsHorizontalIcon({ className = "w-3 h-3" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
